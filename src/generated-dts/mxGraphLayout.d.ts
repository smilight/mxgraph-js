...
export declare class mxGraphLayout {
  ...
  isAncestor(parent: unknown, child: unknown, traverseAncestors: unknown): unknown;
  isVertexMovable(cell: unknown): unknown;
  isVertexIgnored(vertex: number): unknown;
  isEdgeIgnored(edge: unknown): unknown;
  ...
  static traverse(vertex: number, directed: unknown, func: unknown, edge: unknown, visited: boolean): unknown;
}