...
export declare class mxText {
  ...
  getAutoDirection(...args: any[]): unknown;
  getContentNode(...args: any[]): unknown;
  ...
  redrawHtmlShapeWithCss3(...args: any[]): void;
  updateHtmlTransform(...args: any[]): void;
  updateInnerHtml(elt: unknown): void;
  updateHtmlFilter(...args: any[]): void;
  updateValue(...args: any[]): void;
  updateFont(node: unknown): void;
  updateSize(node: unknown, enableWrap: unknown): void;
  updateMargin(...args: any[]): void;
  getSpacing(...args: any[]): unknown;
}