...
export declare class mxLabel {
  ...
  paintIndicator(c: unknown, x: number, y: number, w: unknown, h: unknown): unknown;
  getIndicatorBounds(x: number, y: number, w: unknown, h: unknown): unknown;
